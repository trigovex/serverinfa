...
app.get('/sendOrderAsSms',async (req,res)=>{
   ...
   var options = {authorization :'4XUer6PRhuiBjEGCH71wxNZILJMY3n8OW0TFakDb2dypqf9ztoeoUMdvbi0rj6PCEpI5DnJSwfGYkgca' , message : 'Customer:- '+customername+'\t Mobile No:-'+phonenumber+' with Order Id:-'+orderid ,  numbers : ['7013325735']} 
